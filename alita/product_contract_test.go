...
func TestProductContract(t *testing.T) {
	...
	want := productContract{
		Commands: []string{
			...
			"disabledel", "disconnect", "donate", "dwarn", "enable", "export",
			...
			"privaterules", "privnote", "promote", "purge",
			...
			"resetrulesbutton", "resetwarn", "resetwarns", "resetwelcome", "rmallbl",
			"rmblacklist", "rmfilter", "rmnote", "rmwarn", "rules", "rulesbtn", "rulesbutton", "save",
			"saved", "setflood", "setfloodmode", "setgoodbye", "setrules", "setwarnlimit",
			"setwarnmode", "setwelcome", "start", "stat", "stats", "stop", "stopall",
			"swarn", "teamusers", "tell", "title", "unapprove", "unapproveall",
			"unban", "unlock", "unmute", "unpin", "unpinall", "unwarn", "warn",
