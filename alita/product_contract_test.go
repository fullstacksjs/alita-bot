...
func TestProductContract(t *testing.T) {
	...
	want := productContract{
		Commands: []string{
			...
			"connection", "dban", "del", "delflood", "demote", "disable", "disableable", "disabled",
			"disabledel", "disconnect", "dkick", "dmute", "donate", "dwarn", "enable", "export",
			"filter", "filters", "flood", "formatting", "get", "goodbye", "help", "id", "import",
			"info", "invitelink", "kick", "kickme", "leavechat", "lock", "locks", "locktypes",
			"markdownhelp", "mute", "notes", "permapin", "pin", "ping", "pinned", "privatenotes",
			"privaterules", "privnote", "promote", "purge", "purgefrom", "purgeto",
			"raidactiontime", "raidtime", "reactions", "reconnect", "remallbl", "remdev",
			"removebotkeyboard", "removefilter", "removereaction", "remsudo", "report", "reports",
			"reset", "resetallwarns", "resetgoodbye", "resetreactions", "resetrules", "resetrulesbtn",
			"resetrulesbutton", "resetwarn", "resetwarns", "resetwelcome", "restrict", "rmallbl",
			"rmblacklist", "rmfilter", "rmnote", "rmwarn", "rules", "rulesbtn", "rulesbutton", "save",
			"saved", "sban", "setflood", "setfloodmode", "setgoodbye", "setrules", "setwarnlimit",
			"setwarnmode", "setwelcome", "smute", "start", "stat", "stats", "stop", "stopall",
			"swarn", "tban", "teamusers", "tell", "title", "tmute", "unapprove", "unapproveall",
			"unban", "unlock", "unmute", "unpin", "unpinall", "unrestrict", "unwarn", "warn",
			"warnings", "warns", "welcome",
		},
		CallbackNamespaces: []string{
			"about", "anon_admin", "antiraid", "backup", "captcha_refresh", "captcha_verify",
			"configuration", "connbtns", "deleteMsg", "filters_overwrite", "formatting", "helpq",
			"notes.overwrite", "reactions_help", "report", "restrict", "rmAllApprovals",
			"rmAllBlacklist", "rmAllChatWarns", "rmAllFilters", "rmAllNotes", "rmWarn",
			"unpinallbtn", "unrestrict",
		},
		Watchers: []watcherContract{
			...
			{Group: 0, Kind: "chat_join_request", Count: 1},
			{Group: 0, Kind: "chat_member", Count: 4},
